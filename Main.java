...
public class Main
{
	...
	public static void main(String[] args)
	{
		...
		Person p2 = new Person("D'Andra", "they,them, theirs", "I am an African-American trans woman.", -20);
	...
	public static void comparePeople(Person[] group) {
		...
		System.out.println("\nSummary ofprivelage estimates:");
		for (int i = 0; i < group.length - 1; i++) {
			comparePeople = user.compareTo(group[i]);

			if (comparePeople > 0) {
				System.out.println("More privelage than " + group[i].getName());
			} else if (comparePeople == 0) {
				System.out.println("Same privelage as " + group[i].getName());
			} else {
	...
	public static void fillInfo(Person person){
		...
		System.out.println("Here is a list of common examples of preferred pronous:");
		System.out.println("Gender Neutral/Nonbinary: they/them/their(s) or ze/hir/hirs");
		System.out.println("Feminie: she/her/hers");
		System.out.println("Masculine: he/him/his");
		System.out.println("What are your preffered pronouns?");
